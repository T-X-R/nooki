...
const unavailable = async (): Promise<never> => { throw new Error('This Host operation requires desktop Workbench; preview does not execute it.') }
const tasks: [] = []
...
const host: CapabilityHost = {
  ...
  documents: { publish: unavailable, listGrants: async () => [], readSelected: unavailable, open: () => { window.alert('Open this reference in desktop Workbench.') } },
...
function Preview() {
  ...
  return <><aside className="preview-toolbar"><strong>Workbench · UI preview</strong><span>模拟数据 / Simulated data</span>
