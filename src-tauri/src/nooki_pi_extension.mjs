...
export default function (pi) {
  pi.registerTool({
    ...
    description: process.env.NOOKI_CAPABILITY_DESCRIPTION || "Discover and use installed Nooki capability commands when relevant to the user's request. Search shows command names and descriptions; describe loads one command's schema; invoke runs it. For commands that accept conversation sources, Nooki supplies this turn's attachments automatically.",
    parameters,
