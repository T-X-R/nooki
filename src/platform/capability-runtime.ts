...
import { applyPackageStyles, loadPackageModule, removePackageStyles, type PackagePayload } from './package-loader.ts'
import {
...
export type { CapabilityModule } from '../../packages/capability-contract/src/index.ts'
