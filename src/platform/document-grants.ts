...
import type { DocumentGrant, DocumentReference, SelectedDocument } from '../../packages/capability-contract/src/index.ts'
import { readLibraryDocument } from './document-library.ts'
