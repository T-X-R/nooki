...
import type { DocumentPublication, SelectedDocument } from '../../../packages/capability-contract/src/index.ts'
import { publicationReference } from '../../../packages/capability-contract/src/references.ts'
import { readLibraryDocument, publishCapabilityDocument, changeLibrary, libraryOrganization } from '../../platform/document-library.ts'
import { activityStore } from '../../platform/activity.ts'
import { CONVERSATION_OWNER, libraryContext, type ConversationInput, type ConversationResult, type SaveAnswerInput } from './conversation-model.ts'
import type { TaskJob } from '../../platform/task-runner.ts'
import { validateAttachments } from './conversation-documents.ts'
