...
import type { ConversationArtifact } from './conversation-documents.ts'
import { DocumentComparison, LibraryDialog } from '../library/LibraryDialogs.tsx'
import Markdown from 'react-markdown'
import remarkGfm from 'remark-gfm'
import { parseReferenceHref } from '../../../packages/capability-contract/src/references.ts'
import { downloadText } from '../../platform/user-data.ts'
